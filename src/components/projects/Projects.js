...
export const Projects = () => {
  const projects = [
    {
      type: "React as Frontend",
      projects: [
        {
          title: "Mango Seller and Customer",
          description: [
            "Good Animations using css",
            "Responsive for any screen",
            "Effective use of custom hooks and Higher Order Component",
            "Firebase Storage to save product images",
          ],
          imgUrl: [
        ...
        },
        {
          ...
          description: [
            "Best ui for great user Experience",
            "Firebase authentication and realtime database used for backend",
        ...
        },
        {
          ...
          description: [
            "Developed a responsive user interface using ReactJs.",
            "Redux for storing client side data",
            "Firebase for database and deployment",
            "Verify email and forgot password functions are available",
        ...
        },
        {
          ...
          description: [
            "Context API is used to store data on client side of application.",
            "React router is used for page navigation",
            "Git and GitHub are used to version control",
            "User Specific cart for each login",
          ],
          imgUrl: [
    ...
    {
      type: "Fullstack Developments",
      projects: [
        {
          title: "Expense",
          description: [
            "ExpressJs,NodeJs,bcrypt and JWT are used",
            "Added login and logout using bcrypt to store password and compare",
            "JWT token to sent the token to frontend",
        ...
        },
        {
          ...
          description: [
            ...
            "Dynamic routes and pre rendered components created",
          ],
          imgUrl: [
      ...
      projects: [
        {
          ...
          description: [
            "This Extension is created using ReactJs",
            "Nice animations are used to animate the screen and have nice user experience",
        ...
        },
        {
          ...
          description: [
            ...
            "Available online for anyone who is using Sharpener can use it",
          ],
          imgUrl: [
  ...
  return (
    <section className={classes.project} id="projects">
      <h2>Projects</h2>
      {projects.map((e) => {
        return <ProjectType key={e.type} e={e} />;
      })}
    </section>
  );
};
